...
const PopularContest = () => {
  ...
  const { user } = useAuth(); // ✅ real login state
    ...
    <section className="bg-base-200 py-16">
      <div className="container mx-auto px-5">
        ...
        <p className="text-center mb-8 font-bold">
          Here we have some popular contests. If you show all of our contests,
          please click the button show all and enjoy with us.
        </p>
